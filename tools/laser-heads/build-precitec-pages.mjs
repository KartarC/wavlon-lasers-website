...
const products = [
  {
    ...
    primaryImage: '/assets/laser-heads/precitec/procutter-thunder/thunder-product.webp',
    ...
    images: [
      ...
      ['/assets/laser-heads/precitec/procutter-thunder/thunder-product.webp', 'ProCutter Thunder product view'],
  ...
  },
  {
    ...
    primaryImage: '/assets/laser-heads/precitec/procutter-2-0/procutter-product.webp',
    ...
    images: [
      ...
      ['/assets/laser-heads/precitec/procutter-2-0/procutter-product.webp', 'ProCutter 2.0 product view'],
...
<section class="lh2-hero">
  <div class="lh2-wrap">
    ...
    <div class="lh2-hero-grid">
      ...
      <div class="lh2-stage" aria-label="BOCI and Precitec laser cutting head options">
        <img class="stage-mark" src="/assets/laser-heads/precitec/precitec-logo.svg" alt="Precitec"/>
        <img class="stage-left" src="/assets/blt4-thumb.png" alt="BOCI BLT cutting head"/>
        <img class="stage-main" src="/assets/laser-heads/precitec/procutter-2-0/procutter-product.webp" alt="Precitec ProCutter 2.0"/>
        <span class="lh2-stage-label">BOCI BLT · Precitec ProCutter</span>
      </div>
    </div>
...
<section class="lh2-section" id="brands"><div class="lh2-wrap">
  ...
  <div class="lh2-brand-grid">
    <a class="lh2-brand-card lh2-brand-card--dark" href="/technologies/laser-heads/2d-cutting-heads/">
      ...
      <img class="lh2-brand-machine" src="/assets/blt4-thumb.png" alt="BOCI BLT4 intelligent cutting head" loading="lazy"/>
    </a>
    <a class="lh2-brand-card" href="/technologies/laser-heads/precitec/">
      ...
      <img class="lh2-brand-machine" src="/assets/laser-heads/precitec/procutter-thunder/thunder-product.webp" alt="Precitec ProCutter Thunder" loading="lazy"/>
    </a>
  </div>
</div></section>
...
llms = llms.replace('- [Laser Heads and Controllers](https://wavlonlasers.com/technologies/laser-heads/)', '- [Laser Heads and Controllers](https://wavlonlasers.com/technologies/laser-heads/) — BOCI BLT and Precitec ProCutter options with Bochu control systems');
